...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.player_sprite = arcade.Sprite(":resources:images/animated_characters/robot/robot_walk1.png",
                                           scale=0.55)
        ...
        for x in range(173, 650, 64):
            wall = arcade.Sprite(":resources:images/tiles/sandCenter.png", SPRITE_SCALING_BOX)
            wall.center_x = x
            wall.center_y = 350
